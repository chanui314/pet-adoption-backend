    ...
    try:
        with db.cursor() as cur:
            cur.execute(
                ...
                LEFT JOIN animals a
                    ON a.chip_number COLLATE utf8mb4_0900_ai_ci
                     = ap.chip_number COLLATE utf8mb4_0900_ai_ci
                LEFT JOIN users adopter
                    ON adopter.id = ap.user_id
        ...
        return [serial(row) for row in rows]
